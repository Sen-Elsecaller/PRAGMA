...
@export_range(0, 15) var limit: int = 10 ## Maximum number of this SoundEffect to play simultaneously before culled.
...
@export_range(-40, 20) var volume: float = -7.5 ## The volume of the [member sound_effect].
